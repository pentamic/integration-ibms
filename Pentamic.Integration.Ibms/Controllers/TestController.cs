            ...
            else
            {
                        ...
                        if (xdata != null)
                        {
                            ...
                            foreach (var item in xdata)
                            {
                                ...
                                catch (Exception axxx)
                                {
                                    ...
                                    mess_err += axxx.Message + " ; ";//Thong bao loi
                            ...
                            if (xdata != null)
                            {
                                foreach (var item in xdata)
                                {
                                    ...
                                    catch (Exception axx)
                                    {
                                        ...
                                        mess_err += axx.Message + " ; ";//Luu thong bao
                ...
                if (mess_err != "")
                {
                    using (var context = new ApplicationDbContext())
                    {
                        ...
                        sync.Status = false;
                        sync.Type = protocol.protocol_id == protocol_receipt ? "Receipt" : protocol.protocol_id == protocol_checkin ? "CheckIn" : "";
